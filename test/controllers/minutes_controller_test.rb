...
class MinutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create minute" do
    assert_difference("Minute.count") do
      post minutes_url, params: { minute: { content: @minute.content, meeting_date: @minute.meeting_date } }
    end
  ...
  test "should update minute" do
    patch minute_url(@minute), params: { minute: { content: @minute.content, meeting_date: @minute.meeting_date } }
